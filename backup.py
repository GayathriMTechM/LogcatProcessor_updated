...
if __name__ == "__main__":
    # filename = "C:/Users/SS00997234/Desktop/MyProjects/Dish Project/Logcats/Logcat-MNO_UX_TC_VoiceCall_Tests-Voice_Call-2-REFERENCE-R5CT92MP23R--10152023070947.txt"
    project_name = 1
    project_id = 2
    test_case_name = 3
    tc_id = 4
    ...
    # db_name = "ITMS_AND_FILE_MIX_TEST"
    # collection_name = "itms_final_test"
