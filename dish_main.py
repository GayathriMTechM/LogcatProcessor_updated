...
def merge_and_store_data(filename, project_name, project_id, test_case_name, tc_id, test_exec_id, iteration_id, device_type, id, current_iteration_number, mongodb_url, collection_name, db_name):
    ...
    for records in [kpi_records, telecom_records, sipmsg_records, smsservicemodule_records, resipsms_records, imssmsdispatcher_records,smsmessage_records, stpservice_records, imsphonecall_records, networkcontroller_records]:
...
if __name__ == "__main__":
    ...
    # collection_name = "Dish_Output_10_nov"
